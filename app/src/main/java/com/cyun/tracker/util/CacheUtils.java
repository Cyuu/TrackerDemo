...
public class CacheUtils {
    ...
    /**
     * 获取文件<br/>
     * Context.getExternalFilesDir() <br/>
     * SDCard/Android/data/你的应用的包名/files/<br/>
     * 目录，一般放一些长时间保存的数据<br/>
     * Context.getExternalCacheDir() --><br/>
     * SDCard/Android/data/你的应用包名/cache/目录，一般存放临时缓存数据br/>
     *
     * @param file
     * @return
     * @throws Exception
...
//	/**
//	 * 清除本应用SharedPreference(/data/data/com.xxx.xxx/shared_prefs) context
//	 */
